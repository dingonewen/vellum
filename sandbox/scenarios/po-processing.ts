  ...
  steps: [
    // ── Step 0: Tifa sends PO with PDF attachment ─────────────────
    {
      ...
      bodyTemplate:
        ...
        '<p>Regards,<br/><strong>${primary_name}</strong><br/>Procurement Manager<br/>Shinra Manufacturing</p>',
      delaySeconds: 0,
      variables: { primary_name: 'Tifa', cloud_name: 'Cloud' },
      attachments: [
        {
    ...
    // ── Step 1: Cloud confirms ──────────────────────────────────
    {
      ...
      bodyTemplate:
        ...
        '<p>Best regards,<br/><strong>${cloud_name}</strong><br/>Sales Representative<br/>Nibelheim Precision Parts</p>',
    ...
    // ── Step 11: Cloud — shipped with tracking ─────────────────
    {
      ...
      bodyTemplate:
        ...
        '<p>${primary_name}, I know this didn\'t go as smoothly as either of us wanted. I\'ve done a full review with our production manager to improve in-process QC flagging — your feedback about early notification was completely fair and we\'re making changes so this doesn\'t repeat.</p>\n' +
